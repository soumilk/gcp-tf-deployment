...
variable "tags" {
  type        = list(string)
  description = "The tags provided to the cluster (required)"
}

variable "description" {
  type        = string
  description = "The description of the cluster"
  default     = "The cluster for the TW demo"
}
...
variable "datapath_provider" {
  type        = string
  description = "The desired datapath provider for this cluster. By default, `LEGACY_DATAPATH` enables the IPTables-based kube-proxy implementation. `ADVANCED_DATAPATH` enables Dataplane-V2 feature."
...
variable "node_pools" {
  ...
  description = "List of maps containing node pools configuration"
  default     = []
}
...
variable "argo_repo_url" {
  ...
  default     = "https://github.com/LambdatestIncPrivate/tw-base-deployment.git"
}
